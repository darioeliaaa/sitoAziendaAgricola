...
export class ChiSiamo {
  ...
  storia = [
    "L'Azienda Agricola nasce dal profondo legame con il territorio calabrese. Da decenni ci dedichiamo alla cura dei nostri uliveti, tramandando di padre in figlio le tecniche di potatura e raccolta.",
